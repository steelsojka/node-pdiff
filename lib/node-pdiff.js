 ...
 *   @param {Object}        [options.webshotOptions]    Webshot options. Refer to the node-webshot API
...
var compare = function(options, cb) {
	...
	var captureOptions = {
		...
		options: _.extend(webshotDefaults, config.webshotOptions)
	};
...
var capture = function(shots, cb) {
	...
	if (Array.isArray(shots)) {
		...
		async.series([_.partial(takeShot, shots)], callback);
	}
};
